//! The Substrate Node oumuamua runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("project"),
    impl_name: create_runtime_str!("project"),
    authoring_version: 3,
    spec_version: 4,
    impl_version: 4,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
        ...
        Account: account::{Modul, Call, Storage, Event<T>,}
	}
);
